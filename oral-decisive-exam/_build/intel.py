...
ROWS = [
    ...
    ("台大　戴浩志", "🟡 只知道人",
     "台大這一關確定是<strong>戴浩志理事長</strong>",
     "台大這一關是<strong>戴浩志理事長</strong>。"
     "⚠ <strong>只確認人選，沒有給任何出題方向。</strong>〔同學回報〕",
     "✅ 手冊對他的記錄很完整——他是 114 年 15 站裡<strong>出題最密集的一關</strong>，"
     "用一張全喉咽切除的照片問滿六題，當場指名 Neligan 第五版第三卷第十三章。"
     "語音課 <strong>EP09 整集</strong>就是這一關。",
     "⚠ <strong>有人沒有題目，所以範圍不能縮。</strong>照手冊的既有檔案準備即可，"
     "顯微重建全線都要備。⭐ 但這個情報有另一個用途：<strong>台大的名額被佔住了</strong>，"
     "所以同院的洪學義（104–105）可以跳過——見〈可以跳過的考官〉。"),
